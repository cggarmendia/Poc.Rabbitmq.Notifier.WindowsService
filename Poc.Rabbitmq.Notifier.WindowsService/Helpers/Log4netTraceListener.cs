...
namespace Poc.Rabbitmq.Notifier.WindowsService.Helpers
{
 	...
 	public class Log4netTraceListener : TraceListener
    {
        ...
        private readonly List<string> ForbiddenLogs = new List<string>()
        {
            "Supervisor: Checking consumers are alive",
            "Supervisor: Check complete"
        };
        #endregion

        #region Variables
        private static readonly ILog _log = LogManager.GetLogger("Vueling.Contingency.CrmNotifier.WindowsService");
        #endregion
